  ...
  return (
    <Card delay={0.05}>
      <SectionTitle
        ...
        lead="Маршрут средств — от рублёвого фондирования до передачи USDT заказчику через инструмент залога — состоит из четырёх стадий. Конвертация выполняется внутри инфраструктуры агента (банковский счёт → брокерский счёт), при этом объём USDT для заказчика рассчитывается по курсу, зафиксированному договором займа."
      />
